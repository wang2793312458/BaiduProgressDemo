package com.dreamlive.baiduprogressdemo;
...
public class BaiduProgress extends View {
    ...
    public BaiduProgress(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaiduProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
